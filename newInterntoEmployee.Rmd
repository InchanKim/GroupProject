...
stayed <- organizName %>% filter(organizationId == intOrganizationId) %>% distinct(graduationId, .keep_all = TRUE)

ftstay <- left_join(stayed, fulltime, by = "idCurrentPosition") %>% select(organizationId:salary) %>% distinct(salary) 
...
>>>>>>> 80c3440624d61863d0ced106b23b3a1a358ed35d
