...
```
According to the graph above, there are `r yyy[2,2]` students who have done internships, and there are `r yyy[1,2]` students who did not have internships.
...
xxx %>% 
  ggplot() +
  geom_bar(aes(x = interns, color = interns)) +
...
This graph tells us that students with more internships recevied less low salary than students with no internship experience.
