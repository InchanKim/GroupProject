...
tn <- total %>% filter(internshipPaid== "no")
ty <- total %>% filter(internshipPaid== "yes")
```
...
From this number there is a total of `r tn$n`unpaid internships, and `r ty$n`5440 paid internships taken by students that graduated in 2017.  
