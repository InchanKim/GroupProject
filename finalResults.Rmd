...
```
As we have stated previously, of all of the LSU graduates from 2017, `r count(paid)` had internships while completing their degree.  

From this number there is a total of `r oo[1,2]`unpaid internships, and `r oo[2,2]`5440 paid internships taken by students that graduated in 2017.  
